...
export default function Contact() {
  return (
    <div className="bg-[#0D0E11] w-full flex flex-col items-center justify-center text-xl gap-8 py-16 px-4">
      <h4 className='text-[#BB72E8] text-2xl'>Contact</h4>
      ...
      <div className="flex flex-col gap-4 w-full max-w-md">
        {contacts.map((contact, index) => (
          <Link
            key={index}
            href={contact.link}
            className="flex items-center justify-between text-blue-500 hover:text-blue-700 transition bg-[#292C34] py-4 px-6 rounded-lg"
          >
